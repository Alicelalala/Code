...
int get_message_filename (int bit, char *filename) {
            switch (bit) {
                case 100: {
                    sprintf(filename, "cat ~/shell/cpu.log");
                } break;
                case 101: {
                    sprintf(filename, "cat ~/shell/mem.log");
                } break;
                case 102: {
                    sprintf(filename, "cat ~/shell/disk.log");
                } break;
                case 103: {
                    sprintf(filename, "cat ~/shell/sysinfo.log");
                } break;
                case 104: {
                    sprintf(filename, "cat ~/shell/user.log");
                } break;
                case 105: {
                    sprintf(filename, "cat ~/shell/proc.log");
                } break;
                default : {
                    printf("bit error\n");
                    return 0;
