/*************************************************************************
	> File Name: 21.thread.cpp
	> Author: caohaiyan
	> Mail: 877022406@qq.com
	> Created Time: 2018年11月04日 星期日 11时23分04秒
 ************************************************************************/
...
int output_t (Node *root) {
    ...
    printf("\n");
    root->ltag == NORMAL && output_t(root->lchild);
    root->rtag == NORMAL && output_t(root->rchild);
    return 0;
}
